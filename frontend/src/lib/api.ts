...
export type DetectAllRequest = { start_date: string; end_date: string; chart_type?: 'candle' | 'line' | 'ohlc'; data_source?: 'live' | 'past'; stock_data_dir?: string; stock_limit?: number }
